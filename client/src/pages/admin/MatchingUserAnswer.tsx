...
import matchingUserAnswerService from "../../services/matchingUserAnswerService";
...
export default function MatchingUserAnswerPage() {
    const [answers, setAnswers] = useState<MatchingUserAnswer[]>([]);
    ...
    const fetchAnswers = async () => {
        setLoading(true);
        try {
            const res = await matchingUserAnswerService.list();
            // Xử lý dữ liệu trả về từ Laravel Paginate hoặc mảng phẳng
    ...
    const filtered = answers.filter(a =>
        a.muw_id.toLowerCase().includes(search.toLowerCase()) ||
            ...
            <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 28 }}>
                <div>
                    ...
                    <p style={{ color: "#64748b", margin: "4px 0 0", fontSize: 14 }}>
                        Bài làm của học viên cho câu hỏi nối
                    </p>
                </div>
            </div>
                    ...
                    <table style={{ width: "100%", borderCollapse: "collapse", textAlign: "left" }}>
                        <thead>
                            <tr style={{ background: "#f8fafc", borderBottom: "1px solid #f1f5f9" }}>
                                ...
                                <th style={{ padding: "14px 20px", fontSize: 12, fontWeight: 600, color: "#64748b", textTransform: "uppercase" }}>Nối</th>
                        ...
                        <tbody>
                            {loading ? (
                                ...
                                <tr key={ans.muw_id} style={{ borderBottom: "1px solid #f1f5f9" }}>
