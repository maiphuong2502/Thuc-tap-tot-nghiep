...
use App\Repositories\SpeakingSubmissionRepositoryInterface;
use App\Models\User;
use App\Models\Question;
use Illuminate\Validation\ValidationException;

class SpeakingSubmissionService implements SpeakingSubmissionServiceInterface
{
    protected $repository;

    public function __construct(SpeakingSubmissionRepositoryInterface $repository)
    {
